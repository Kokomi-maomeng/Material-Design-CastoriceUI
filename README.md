...
![Version](https://img.shields.io/badge/version-2.6.0-6750A4)
...
安全边界及漏洞报告方式见 [`SECURITY.md`](SECURITY.md)，贡献要求见 [`CONTRIBUTING.md`](CONTRIBUTING.md)，本次发布说明见 [`docs/RELEASE_NOTES_v2.6.0.md`](docs/RELEASE_NOTES_v2.6.0.md)。
