...
export function AccountsPage({ accounts, integration, onConfigure }: { accounts: Account[]; integration?: IntegrationStatus; onConfigure: () => void }) {
  ...
  return <div className="page-content page-enter">
    <PageHeader eyebrow={t("访问控制", "Access control")} title={t("账号管理", "Accounts")} description={t("查看服务器配置账号、真实核心累计用量、统一流量额度与有效期。", "Review server-configured accounts, real core cumulative usage, the shared traffic quota, and expiry dates.")} />
