...
export function FirstRunConfiguration({ metrics, integrations, onConfigure, onSaveBasics, onComplete }: {
  ...
  return <main className="first-run-page">
      <div className="first-run-header"><div className="auth-brand"><span className="brand-mark"><Icon name="ac_unit" size={26} filled /></span><div><strong>CastoriceUI</strong><span>v3.5</span></div></div><Chip staticChip tone="warning" icon="checklist">{t("首次初始化", "First-run setup")}</Chip></div>
