...
export const emptyDashboard: DashboardPayload = {
  ...
  overview: {
    ...
    trafficQuota: { bytes: 0, autoReset: false, periodUnit: "month", periodCount: 1, resetAnchor: "2000-01-01", timezone: "UTC", cycleStart: new Date(0).toISOString(), nextReset: null },
