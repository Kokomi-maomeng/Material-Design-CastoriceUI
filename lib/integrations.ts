...
export const integrationDefinitions: IntegrationDefinition[] = [
  ...
  { id: "connections", name: "连接快照", icon: "lan", page: "connections", summary: "合并协议 API 返回的活动流或连接条目；页面每 5 秒拉取后端快照。", outcome: "缺失的来源 IP、速率或开始时间明确显示为核心未提供。", steps: ["确认至少一个协议适配器已连接", "自动读取核心可提供的字段", "不把未知字段补为 0、当前时间或设备数量"], fields: [] },
